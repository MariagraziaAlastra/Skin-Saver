...
var LEN_STR = 'len';
var DIVIDER = '*';	
var START_LI = '<li id ="after" class="ui-btn ui-btn-icon-right ui-li ui-li-has-alt ui-btn-up-a" data-theme="a" data-iconpos="right" data-icon="false" data-wrapperels="div" data-iconshadow="true" data-shadow="false" data-corners="false">' +
			   '<div class="ui-btn-inner ui-li ui-li-has-alt"><div class="ui-btn-text">' +
			   '<a class="ui-link-inherit" href="#" style="padding-top: 0px;padding-bottom: 0px;padding-right: 0px;padding-left: 0px;">';
var END_LI = '<a aria-owns="#edit" aria-haspopup="true" data-iconpos="notext" data-icon="false" data-wrapperels="span" data-iconshadow="true" data-shadow="false" data-corners="false" id="sidebutton" class="ui-li-link-alt ui-btn ui-btn-icon-notext ui-corner-tr ui-btn-up-a" title="Edit" href="#edit" data-theme="a" data-rel="popup" data-position-to="window" data-transition="flip"><span class="ui-btn-inner ui-corner-tr"><span class="ui-btn-text">' + 
			 '</span><span class="ui-btn ui-shadow ui-btn-corner-all ui-btn-icon-notext ui-btn-up-a" title="" data-theme="a" data-iconpos="notext" data-icon="edit" data-wrapperels="span" data-iconshadow="true" data-shadow="true" data-corners="true"><span class="ui-btn-inner ui-btn-corner-all ui-corner-tr"><span class="ui-btn-text ui-corner-tr"></span><span class="ui-icon ui-icon-edit ui-icon-shadow">&nbsp;</span></span></span></span></a></li>';
var START_H3 = '<h3>';
var END_H3 = '</h3>';
var START_CHECK = '<div class="ui-checkbox">' +
				'<label class="ui-btn ui-btn-icon-left ui-checkbox-off ui-btn-up-a" data-theme="a" data-icon="checkbox-off" data-wrapperels="span"' + 
				'data-iconshadow="true" data-shadow="false" style="border-top-width: 0px;margin-top: 0px;border-bottom-width: 0px;' +
				'margin-bottom: 0px;border-left-width: 0px;border-right-width: 0px;" data-corners="false">' +
				'<span class="ui-btn-inner ui-corner-top"><span class="ui-btn-text">' +
...
var END_CHECK = '</label></label></div></fieldset></span><span class="ui-icon ui-icon-checkbox-off ui-icon-shadow">&nbsp;</span></span></label>' +
    			'<input name="checkbox-2b" id="checkbox-2b" type="checkbox"></div></a></div></div>';
var START_P = '<p>';
var END_P = '</p>';
...
function newFiles() {	
  // initialize XML document and load it
  var xmlDoc=document.implementation.createDocument("","",null);
  xmlDoc.async=false;
  xmlDoc.load("bad.xml");
  var root = xmlDoc.documentElement;
  var names = root.getElementsByTagName('name');
  var descs = root.getElementsByTagName('desc');

  $('.list').children().remove('li');
  for (var i = 0; i < names.length; i++){
    var name = names[i].childNodes[0].nodeValue;
    var desc = descs[i].childNodes[0].nodeValue
    bads[name] = desc;
